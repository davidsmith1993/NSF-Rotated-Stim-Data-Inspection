function [error,corr,nMVoutliers] = calc_standardized_error_collapse(MyData,or_scale,diameter_scale,inferDimensionCol,diameter_responseCol,diameterCol,orient_responseCol,orientCol,checkOutliers)
...
corrdata = [[tempdata_inferdiameter(:,diameter_responseCol) tempdata_inferdiameter(:,orientCol)*or_scale];[ tempdata_inferorient(:,diameterCol)*diameter_scale tempdata_inferorient(:,orient_responseCol)]];
